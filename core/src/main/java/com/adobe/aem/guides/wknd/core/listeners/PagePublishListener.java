...
public class PagePublishListener implements EventHandler {
...
//			logger.debug("Page Published : {}", ReplicationAction.fromEvent(event).getPath());
//		}
//		
//		if(ReplicationAction.fromEvent(event).getType().equals(ReplicationActionType.DEACTIVATE)) {
//			logger.debug("Page deactivated : {}", ReplicationAction.fromEvent(event).getPath());
//		}
	}
